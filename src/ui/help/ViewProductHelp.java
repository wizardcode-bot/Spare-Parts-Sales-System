...
public class ViewProductHelp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En la función de 'Ver Producto' el Administrador y Vendedor podrán ver los productos registrados en el sistema."
            + "<br> Se va a desplegar una opción donde dice 'Filtrar por Categoría' donde el Administrador o Vendedor decide que categoría ver"
            + "<br>Se podrán visualizar los siguientes campos del Producto ya existente que son: "
            + "<br>ID del producto, Categoría, Descripción, Marca, Cantidad, Precio Adquirido, Precio Venta, Ubicación y Ultima Modificación."
            + "<br>Si se desea eliminar un producto solo el Administrador podrá hacerlo, el Vendedor no cuenta con esta función. "
