...
public class ManageProductsHelp extends javax.swing.JFrame {

    /**
     * Creates new form ProfileHelp
     */
    public ManageProductsHelp() {
        initComponents();
        setSize(850,500);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En el 'Modulo de Inventario' puedes ver los diferentes módulos con los que cuenta el Administrador y Vendedor"
            + "<br>Los siguientes Módulos son:"
            + "<br>Añadir Producto, Consultar Producto, Actualizar Producto y Ajustes de Inventario. "
            + "<br>Para el Vendedor que use este módulo, tendrá una restricción que es que no puede eliminar ningún producto, pero las otras funcionalidades si podrá usarlas con normalidad"
        ...
        jLabel5.setText("Módulo de Inventario");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageProductsHelp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageProductsHelp().setVisible(true);
            }
        });
    }
