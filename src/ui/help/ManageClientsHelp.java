...
public class ManageClientsHelp extends javax.swing.JFrame {

    /**
     * Creates new form ProfileHelp
     */
    public ManageClientsHelp() {
        initComponents();
        setSize(850,500);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En el 'Modulo de Clientes' puedes ver los diferentes módulos con los que cuenta el Administrador y Vendedor"
            + "<br>Los siguientes Módulos son:"
            + "<br>Registrar Cliente, Ver Clientes, Actualizar Cliente, Registrar Vehículo, Ver Vehículos y Actualizar Vehículo. "
            + "<br>Para el Vendedor que use este módulo, tendrá una restricción que es que no puede eliminar clientes ni vehículos, pero las otras funcionalidades si podrá usarlas con normalidad"
            + "<br>Si el usuario que volver al menú principal ya sea el Panel de Administrador o Panel de Vendedor se le da click."
        ...
        jLabel5.setText("Módulo de Clientes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageClientsHelp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageClientsHelp().setVisible(true);
            }
        });
    }
