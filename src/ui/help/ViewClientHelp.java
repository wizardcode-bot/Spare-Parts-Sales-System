...
public class ViewClientHelp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En la función de 'Ver Cliente' el Administrador y Vendedor podrán ver los clientes registrados en el sistema."
            + "<br><br>Se puede ingresar en la barra de búsqueda el número de cédula o NIT del cliente que se va a buscar y dar click en 'Filtrar' "
            + "para encontrarlo más rápido. "
            + "<br>Solo el Administrador podrá eliminar clientes, el Vendedor no cuenta con esta función. "
            + "<br><br>Recuerda que para mayor información puedes consultar el manual de usuario.</p></html>"
        );
        jLabel8.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 174, 740, 130));
