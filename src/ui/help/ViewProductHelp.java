...
public class ViewProductHelp extends javax.swing.JFrame {

    /**
     * Creates new form ProfileHelp
     */
    public ViewProductHelp() {
        initComponents();
        setSize(850,500);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En la función de 'Consultar Productos' el Administrador y Vendedor podrán ver los productos registrados en el sistema."
            + "<br><br>Los productos se pueden 'Filtrar por Categoría' en la barra desplegable."
            + "<br>Se podrán visualizar todos los datos de los productos registrados y eliminarlos pero no modificarlos. Para modificar algún producto"
            + " debes dirigirte a la sección 'Actualizar producto'."
            + "<br>Solo el Administrador puede eliminar productos, el Vendedor no cuenta con esta función. "
            + "<br><br>Recuerda que para mayor información puedes consultar el manual de usuario.</p></html>"
        );
        jLabel8.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 165, 740, 150));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Ver Producto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewProductHelp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
