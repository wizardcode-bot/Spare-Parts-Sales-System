...
public class ViewVehicleHelp extends javax.swing.JFrame {

    /**
     * Creates new form ProfileHelp
     */
    public ViewVehicleHelp() {
        initComponents();
        setSize(850,500);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En la función de 'Ver Vehículo' el Administrador y Vendedor podrán ver los vehículos registrados en el sistema."
            + "<br><br> Se puede ingresar en la barra de búsqueda el número de placa del vehículo y esta se filtrará automáticamente en la tabla. "
            + "<br>Si alguna moto está registrada y no aparece en esta tabla es porque aún no ha sido asignado un propietario al vehículo, debes "
            + "agregarlo en la opción 'Actualizar vehículo' - 'Relacionar propietario'."
            + "<br>Solo el Administrador podrá eliminar vehículos, el Vendedor no cuenta con esta función. "
            + "<br><br>Recuerda que para mayor información puedes consultar el manual de usuario.</p></html>"
        );
        jLabel8.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 174, 740, 150));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Ver Vehículo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewVehicleHelp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
