...
public class ManageUsersHelp extends javax.swing.JFrame {

    /**
     * Creates new form ProfileHelp
     */
    public ManageUsersHelp() {
        initComponents();
        setSize(850,500);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En el 'Modulo de Usuarios' puedes ver los diferentes módulos con los que cuenta el Administrador "
            + "<br>Los siguientes Módulos son:"
            + "<br>Añadir Usuario, Ver Usuario, Actualizar Usuario y Restablecer Contraseña."
        ...
        jLabel5.setText("Módulo de Usuarios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageUsersHelp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageUsersHelp().setVisible(true);
            }
        });
    }
