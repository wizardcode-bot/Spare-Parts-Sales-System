...
public class Tables {
    public static void main(String[] args) {
        try{
            ...
            //st.executeUpdate("create table appuser(appuser_pk int AUTO_INCREMENT primary key, userRole varchar (50),name varchar(200), dob varchar(50),mobileNumber varchar(100), IDcard varchar(100), username varchar(200), password varchar(255), address varchar(200))");
