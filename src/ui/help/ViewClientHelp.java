...
public class ViewClientHelp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En la función de 'Ver Cliente' el Administrador y Vendedor podrán ver los clientes registrados en el sistema."
            + "<br> Se debe de ingresar en la barra de búsqueda número de cedula del cliente que se va a buscar"
            + "<br>Se podrán visualizar los siguientes campos del cliente ya existente que son: "
            + "<br>ID, Nombre, Teléfono, Dirección y Correo."
            + "<br>Si se desea eliminar un cliente solo el Administrador podrá hacerlo, el Vendedor no cuenta con esta función. "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewClientHelp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
