...
public class ViewVehicleHelp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En la función de 'Ver Vehículo' el Administrador y Vendedor podrán ver los vehículos registrados en el sistema."
            + "<br Se debe de ingresar en la barra de búsqueda número de placa del vehículo que se va a buscar y luego dar click en el botón 'Buscar'. "
            + "<br>Se podrán visualizar los siguientes campos del Vehículo ya existente que son: "
            + "<br>Placa, Marca, Modelo, Cilindraje, Color y Propietario."
            + "<br>Si se desea eliminar un vehículo solo el Administrador podrá hacerlo, el Vendedor no cuenta con esta función. "
