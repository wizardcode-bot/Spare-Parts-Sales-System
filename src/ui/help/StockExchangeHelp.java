 ...
 * @author HOME
 */
public class StockExchangeHelp extends javax.swing.JFrame {

    /**
     * Creates new form StockExchangeHelp
     */
    public StockExchangeHelp() {
        initComponents();
        setSize(850,500);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Intercambio de stock");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(49, 93, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("<html><p>En la función de 'Intercambio de stock' el Administrador puede realizar ajustes de intercambio de productos."
            ...
            + "<br>Luego se debe especificar la cantidad de unidades a intercambiar y el dinero extra recibido o pagado por el intercambio. "
            + "Si no hay diferencia de precio entre los productos intercambiados se debe poner el número cero '0' en ambos campos. Especificar el motivo del intercambio es opcional. "
            + "<br>En cuanto al producto entrante, si no es un producto que ya esté registrado en el inventario de la empresa, debe ser registrado "
            + "dando click en 'Nuevo producto' y siguiendo los pasos para el registro. Si por el contrario la especificación del producto ya existe en la "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockExchangeHelp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockExchangeHelp().setVisible(true);
            }
        });
    }
