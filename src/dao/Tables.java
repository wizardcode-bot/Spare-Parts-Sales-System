...
public class Tables {
    public static void main(String[] args) {
        try{
            ...
            //st.executeUpdate("create table argsppuser(appuser_pk int AUTO_INCREMENT primary key, userRole varchar (200),name varchar(200), dob varchar(50),mobileNumber varchar(200), email varchar(200), username varchar(200), password varchar(50), address varchar(200))");
