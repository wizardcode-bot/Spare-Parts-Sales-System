...
public class UpdatePasswordHelp extends javax.swing.JFrame {

    /**
     * Creates new form ProfileHelp
     */
    public UpdatePasswordHelp() {
        initComponents();
        setSize(850,500);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<html><p>En la función de 'Actualizar Contraseña' puedes actualizar a tu contraseña y asi tener una mejor privacidad."
            + "<br>Primero se al Usuario ingresar su contraseña actualmente donde dice 'Ingrese la contraseña actual'."
            + "<br>Luego ingresa la nueva contraseña que desee en 'Ingrese la nueva contraseña'."
            + "<br>Luego de haber llenado los espacios debes dar click en 'Actualizar'"
            + "<br>Al dar click en 'Actualizar' la nueva contraseña quedara registrada en la base de datos de Usuarios del sistema."
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdatePasswordHelp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdatePasswordHelp().setVisible(true);
            }
        });
    }
