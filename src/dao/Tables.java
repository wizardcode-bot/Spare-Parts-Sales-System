...
public class Tables {
    public static void main(String[] args) {
        try{
            ...
            //st.executeUpdate("create table bills(bill_pk int AUTO_INCREMENT primary key, billId varchar(200), billDate varchar(50), totalPaid bigint, generatedBy varchar(50))");
            //st.executeUpdate("create table clients(client_pk int AUTO_INCREMENT primary key, name varchar(200), mobileNumber varchar(200), address varchar(200), email varchar(200), vehicleInfo varchar(200))");
